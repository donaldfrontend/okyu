...
if(isset($_POST['submenu_submit']))
{
	...
	if($submenu_name!='')
	{
		$insertqry="INSERT INTO `sub_menu`( `menu_id`, `submenu_name`, `submenu_url`, `submenu_display`, `submenu_order`) 
        VALUES ('$menu_id','$submenu_name','$submenu_url','$submenu_display','$submenu_order')";
